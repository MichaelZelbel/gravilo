    ...
    <section className="min-h-screen flex items-center justify-center px-6 pt-20 pb-20">
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="relative max-w-xl mx-auto">
          ...
          <div className="absolute -left-8 top-1/4 text-3xl text-accent/60 font-mono">{"{ }"}</div>
          <div className="absolute -right-8 top-1/3 text-3xl text-secondary/60 font-mono">{"</>"}</div>
          <div className="absolute -left-12 bottom-1/3 text-3xl text-secondary/60 font-mono">{"</>"}</div>
          <div className="absolute -right-12 bottom-1/4 text-3xl text-accent/60 font-mono">{"//"}</div>
          
          {/* Main Glass Container */}
          <div className="glass-card glass-glow neon-glow-blue rounded-3xl relative overflow-visible">
