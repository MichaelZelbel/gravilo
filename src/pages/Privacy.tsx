...
const Privacy = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEOHead title="Privacy Policy - Gravilo" description="Learn how Gravilo collects, uses, and protects your personal data." />
              ...
              <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
                ...
                <section id="interpretation">
                  ...
                  <ul className="list-disc pl-6 space-y-2 mt-4">
                    ...
                    <li><strong className="text-foreground">Website</strong> refers to Gravilo, accessible from https://gravilo.ai</li>
                ...
                <section id="contact">
                  ...
                  <ul className="list-disc pl-6 mt-2">
                    <li>By email: <a href="mailto:support@gravilo.ai" className="text-primary hover:underline">support@gravilo.ai</a></li>
                  </ul>
                </section>
